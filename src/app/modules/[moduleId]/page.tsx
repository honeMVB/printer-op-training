    ...
    return (
      <ProtectedRoute>
        <div className="min-h-screen bg-slate-950 text-white flex flex-col items-center justify-center p-6 text-center">
          ...
          <Link href="/" className="px-5 py-2.5 rounded-xl bg-cyan-500 text-slate-950 font-bold text-sm">
            Back to Dashboard
          </Link>
        </div>
      </ProtectedRoute>
  ...
  return (
    <ProtectedRoute>
      <div className="min-h-screen bg-slate-950 text-white pb-20">
        ...
        <div className="bg-slate-900/90 border-b border-slate-800 px-4 sm:px-6 lg:px-8 py-4 backdrop-blur-md sticky top-16 z-40">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 text-xs text-slate-400">
              <span className="font-bold text-cyan-400">{targetModule.category}</span>
              <span>•</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1 space-y-4">
              <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-5 shadow-xl sticky top-32">
                    ...
                    return (
                      <button
                        ...
                        className={`w-full text-left p-3 rounded-xl text-xs transition-all flex items-start justify-between gap-2 ${
                          active
                            ? 'bg-cyan-500/20 border border-cyan-500/40 text-cyan-300 font-bold shadow-lg shadow-cyan-500/10'
                            : 'bg-slate-800/40 hover:bg-slate-800 border border-transparent text-slate-300'
                        }`}
                      >
                        <div>
                          <span className="block text-[10px] text-slate-500 uppercase font-semibold mb-0.5">
                            Part {idx + 1}
                          </span>
                ...
                <div>
                  <div className="mb-6">
                    <button
                      ...
                      className="text-xs text-cyan-400 hover:underline flex items-center gap-1 mb-2 font-medium"
                    >
                ...
                <div className="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 sm:p-10 shadow-2xl space-y-8">
                  ...
                  <div>
                    <div className="flex items-center gap-3 text-xs text-slate-400 mb-3">
                      <span className="flex items-center gap-1 bg-cyan-500/10 border border-cyan-500/20 px-3 py-1 rounded-full text-cyan-400 font-semibold">
                  ...
                  {/* Key Takeaways Box */}
                  <div className="p-6 rounded-2xl bg-gradient-to-br from-cyan-950/40 to-slate-900 border border-cyan-500/30 space-y-3 shadow-xl">
                    <h4 className="text-sm font-bold text-cyan-400 flex items-center gap-2 uppercase tracking-wider">
                  ...
                  {currentLesson.caseStudy && (
                    <div className="p-6 rounded-2xl bg-amber-500/10 border border-amber-500/30 space-y-3 shadow-xl">
                      ...
                      <div className="p-4 rounded-xl bg-slate-950/90 border border-amber-500/20 text-xs sm:text-sm text-amber-300">
                        <span className="font-bold block mb-1 uppercase tracking-wider text-[10px] text-amber-400">Key Practical Lesson:</span>
                  ...
                  <div className="pt-6 border-t border-slate-800 flex items-center justify-between flex-wrap gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      {activeLessonIdx + 1 < targetModule.lessons.length ? (
                        <button
                          onClick={() => setActiveLessonIdx(activeLessonIdx + 1)}
                          className="flex items-center gap-1.5 px-5 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-xs font-semibold text-cyan-400 border border-cyan-500/30"
                        >
                        ...
                        targetQuiz && (
                          <button
                            onClick={() => setShowQuiz(true)}
                            className="flex items-center gap-1.5 px-5 py-2.5 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-slate-950 text-xs font-bold shadow-lg shadow-cyan-500/20"
                          >
